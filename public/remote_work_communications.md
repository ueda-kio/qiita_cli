...
テキストではあまりに完結な文章だと相手に淡白で冷たい印象を与える場合がありますが、**口頭では逆に「より完結に」を意識するとよい** です。口頭では敬語や（過剰な）枕詞、フィラー言葉[^1]などで、冗長になりがちだからです。

完結に話すための方法として **言葉を切る** ということを私は普段意識しています。
具体的には「枕詞を減らす」「断言する」また「結論だけ」

「枕詞を減らす」では、極端な例ですが以下。
「え〜ここまでで、なにか疑問に思ったり、わからない点などがありましたら、え〜テキストでも口頭でも構いませんので、ご自由に発言していただければと、思います。」
「ここまでで気になることがある方いらっしゃいますか？」
前者のようになってしまっている人は意外といると思います。
